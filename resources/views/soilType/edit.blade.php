    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card"> 
                ...
                <div class="card-body">
                    <form class="form-horizontal" method="post" action="/soilType/{{ $soilType->id }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }} row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="name" value='{{ $soilType->name }}' required autofocus>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <a href='/soilType/destroy/{{ $soilType->id }}'>
                                    Delete Soil Type
                                </a>
                            </div>
                        </div>
